...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent i = getIntent();
         ...
         player_1 = i.getStringExtra("PLAYER_1");
         player_2 = i.getStringExtra("PLAYER_2");
        ...
        setInfo(player_1.toUpperCase() + " with X turn");
    ...
    public void onClick(View view) {
        ...
        if(resetButtonPressed){
            ...
            if(PLAYER_X){
                ...
                setInfo(player_2.toUpperCase() +" with 0 turn");
            }
        ...
        for(int i=0; i<3; i++){
            if(boardStatus[i][0] == boardStatus[i][1] && boardStatus[i][0] == boardStatus[i][2]){
                if (boardStatus[i][0]==1){
                    result(player_1.toUpperCase() +" winner\n" + (i+1)+" row");
                    break;
                }
                else if (boardStatus[i][0]==0) {
                    result(player_2 +"winner\n" + (i+1)+" row");
                    break;
                }
            }
        }
        ...
        for(int i=0; i<3; i++){
            if(boardStatus[0][i] == boardStatus[1][i] && boardStatus[0][i] == boardStatus[2][i]){
                if (boardStatus[0][i]==1){
                    ...
                    result(player_2.toUpperCase()+" winner\n" + (i+1)+" column");
                    break;
                }
            }
        }
